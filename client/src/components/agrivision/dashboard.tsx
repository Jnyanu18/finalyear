...
import { BarChart3, CalendarDays, Camera, Gauge, Layers, LineChart, Printer, ShieldAlert, SlidersHorizontal, Sparkles, TrendingUp, UploadCloud, X } from "lucide-react";
  ...
  const detectionForUi: DetectionResult | null = useMemo(() => {
    ...
    return {
      ...
      stageCounts: plantAnalysisResult.stages.reduce((acc: any, s: { stage: string; count: number }) => {
        acc[s.stage.toLowerCase()] = s.count;
        return acc;
      }, {} as any),
          ...
          <div className="relative z-50 w-full max-w-md h-full bg-background p-6 shadow-xl overflow-y-auto animate-in slide-in-from-right duration-300">
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  <label htmlFor="district" className="text-sm font-medium leading-none">District</label>
